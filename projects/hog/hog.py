...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    free_score=2+abs(score%10-score//10)
    return free_score
    # END PROBLEM 2
...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    if min(score0,score1)==0 or min(score0,score1)==1:
        return False
    if max(score0,score1)%min(score0,score1)==0:
        return True
    else:
        return False
    # END PROBLEM 4
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0,score1,previous_high=previous_high,previous_score=previous_score):
        ...
        if gain>previous_high and gain!=1:
            print(str(gain) + " points! That's the biggest gain yet for Player "+str(who))
            previous_high=gain
        elif gain>previous_high and gain==1:
            print(str(gain) + " point! That's the biggest gain yet for Player "+str(who))
            previous_high=gain
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    max_id=0
    for i in range(1,11):
        averaged_dice=make_averaged(roll_dice, num_samples=1000)
        cur_avg=averaged_dice(i,dice)
        if cur_avg>max_avg:
            max_avg=cur_avg
            max_id=i
    return max_id
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    # BEGIN PROBLEM 11
    bacon_gain=free_bacon(opponent_score)
    cur_score=score+bacon_gain
    if is_swap(cur_score, opponent_score)==True and cur_score<opponent_score:
        return 0  # Replace this statement
    elif is_swap(cur_score, opponent_score)==False and bacon_gain>=margin:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
